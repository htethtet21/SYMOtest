...
public class Jwt {
    ...
    public Jwt(String token, Long userId, LocalDateTime issuedAt, LocalDateTime expired) {
        this.token = token;
        this.userId = userId;
    ...
    public static Jwt  of(
        ...
        return new Jwt( Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, Base64.getEncoder().encodeToString(securityKey.getBytes(StandardCharsets.UTF_8)))
                .compact(), userId,
